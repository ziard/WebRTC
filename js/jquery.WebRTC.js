...
(function ($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		capture: function (selector, options) {
			const canvas = $(selector);
			const video = this.element.querySelector('video');
			canvas.each(function () {
				this.width = options.width ? options.width : video.videoWidth;
				this.height = options.height ? options.height : video.videoHeight;
